...
$html = str_replace(
    ...
    'components/admin-hello-button.js?v=20260918-registration20',
    $html
);
...
$headExtras = '<base href="' . $baseAttr . '">'
    ...
    . '<link rel="stylesheet" href="' . $baseAttr . 'components/platform-registration-form.css?v=20260918-19" data-hashcod-platform-registration-style="true">'
...
$bodyExtras = '<script defer src="' . $baseAttr . 'components/legacy-auth-retirement.js?v=20260918-2" data-hashcod-legacy-auth-retirement="true"></script>'
    ...
    . '<script defer src="' . $baseAttr . 'components/platform-entry-hold.js?v=20260918-25" data-platform-entry-hold="true"></script>'
    . '<script defer src="' . $baseAttr . 'components/platform-registration-form.js?v=20260918-25" data-hashcod-platform-registration="true"></script>'
