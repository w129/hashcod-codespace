...
assert(js.includes("assets/plataforma-en-mejora.svg?v=20260917-2"), 'temporary sign asset path missing');
...
assert(css.includes('z-index: 2147483590 !important'), 'temporary sign must render above the entry-hold surface');
...
assert(hosted.includes('temporary-platform-improvement-sign.css?v=20260917-2'), 'hosted sign CSS missing');
assert(hosted.includes('temporary-platform-improvement-sign.js?v=20260917-2'), 'hosted sign runtime missing');
assert(local.includes('temporary-platform-improvement-sign.css?v=20260917-2'), 'local sign CSS missing');
assert(local.includes('temporary-platform-improvement-sign.js?v=20260917-2'), 'local sign runtime missing');
