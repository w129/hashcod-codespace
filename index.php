    ...
    <style>
        ...
        * {
        ...
        .fn, .k, .op, .enter {
            ...
            cursor: pointer;
            font-family: 'IBM Plex Mono', ui-monospace, monospace;
            transition: box-shadow .06s, transform .06s, background .12s;
        }
        ...
        .fn:hover { background: #e2dfd7; }

        /* Teclas numéricas — profundidad física */
        .k {
            height: 58px;
            border-radius: 10px;
            background: #fff;
            ...
            box-shadow: 0 2px 0 #ddd9d1, 0 1px 2px rgba(0,0,0,.05);
        }
        .k:hover { background: #ffffff; }
        .k:active { box-shadow: 0 0 0 #ddd9d1; transform: translateY(2px); }
        ...
        .op {
            ...
            color: #f5f3ed;
            font: 500 19px 'IBM Plex Mono', monospace;
            box-shadow: 0 2px 0 #16140f;
        }
        .op:hover { background: #3c3831; }
        .op:active { box-shadow: 0 0 0 #16140f; transform: translateY(2px); }
        ...
        .enter:hover { background: #262626; }
        .enter:active { box-shadow: 0 0 0 #000; transform: translateY(2px); }

        /* Panel Central Vector Graphic */
        .vector-body {
            padding: 12px;
        }
    ...
    <div class="main-container">
        ...
        <div class="function-drawer-wrapper">
            ...
            <div class="function-drawer" id="functionDrawer">
                ...
                <!-- TECLADO Y PANELES CON EL NUEVO ESTILO ELEGANTE IBM PLEX MONO -->
                    ...
                    <div class="vk-3panel-container">
                        ...
                        <div class="vk-card-panel">
                            ...
                            <div class="vk-card-body">
                                <!-- Fila de funciones -->
                                <div class="fn-grid">
                                    <button class="fn" onclick="pressVirtualKey('x²')">x²</button>
                                    <button class="fn" onclick="pressVirtualKey('√')">√</button>
                                    <button class="fn" onclick="pressVirtualKey('π')">π</button>
                                    <button class="fn" onclick="pressVirtualKey('(')">(</button>
                                    <button class="fn" onclick="pressVirtualKey(')')">)</button>
                                </div>
                                ...
                                <!-- Teclado principal -->
                                <div class="keys-grid">
                                    <button class="k" onclick="pressVirtualKey('7')">7</button>
                                    <button class="k" onclick="pressVirtualKey('8')">8</button>
                                    <button class="k" onclick="pressVirtualKey('9')">9</button>
                                    <button class="op" onclick="pressVirtualKey('+')">+</button>

                                    <button class="k" onclick="pressVirtualKey('4')">4</button>
                                    <button class="k" onclick="pressVirtualKey('5')">5</button>
                                    <button class="k" onclick="pressVirtualKey('6')">6</button>
                                    <button class="op" onclick="pressVirtualKey('-')">−</button>

                                    <button class="k" onclick="pressVirtualKey('1')">1</button>
                                    <button class="k" onclick="pressVirtualKey('2')">2</button>
                                    <button class="k" onclick="pressVirtualKey('3')">3</button>
                                    <button class="op" onclick="pressVirtualKey('*')">×</button>

                                    <button class="k span-2" onclick="pressVirtualKey('0')">0</button>
                                    <button class="k" onclick="pressVirtualKey('.')">.</button>
                                    <button class="enter" onclick="pressVirtualKey('ENTER')">↵</button>
                                </div>
                            </div>
                        </div>

                        <!-- Panel 2: Vector Graphic (Centro con Doble Marco) -->
                        <div class="vk-card-panel">
                            <div class="vk-card-header">
