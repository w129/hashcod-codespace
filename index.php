            ...
            <div class="function-drawer" id="functionDrawer">
                ...
                <div class="virtual-keyboard-white" id="virtualKeyboard">
                    <div class="vk-3panel-container">
                        <!-- Panel 1: Key Window (Izquierda - Limpio a la espera de tus teclas) -->
                        <div class="vk-card-panel">
                            ...
                            <div class="vk-card-body" id="keyWindowBody">
                                <div class="keys-grid-placeholder" style="flex: 1; border: 1px dashed #d0cdcf; border-radius: 8px; background: #ffffff; display: flex; align-items: center; justify-content: center; color: #8c8983; font-size: 12px; font-family: 'IBM Plex Mono', monospace; min-height: 280px; padding: 12px; text-align: center;">
                                    [ Espacio preparado para tus teclas personalizadas ]
                                </div>
                            </div>
                        </div>
