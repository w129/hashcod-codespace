...
function l8_require_html_page($file, $ok = true, $cacheTtl = 0) {
    ...
    if ($file === 'index.php') {
        ...
        $tag = $legacyBlackholeCleanupTag
            ...
            . '<script defer src="' . $base . 'components/platform-entry-hold.js?v=20260918-18" data-platform-entry-hold="true"></script>'
            . '<script defer src="' . $base . 'components/platform-registration-form.js?v=20260918-18" data-hashcod-platform-registration="true"></script>'
            . $rareFolderInlineTag
