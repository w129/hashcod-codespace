...
$headExtras = '<base href="' . $baseAttr . '">'
    ...
    . '<link rel="stylesheet" href="' . $baseAttr . 'components/final-entry-registration.css?v=20260917-1" data-hashcod-final-entry-registration-style="true">'
...
$bodyExtras = '<script defer src="' . $baseAttr . 'components/legacy-auth-retirement.js?v=20260917-1" data-hashcod-legacy-auth-retirement="true"></script>'
    . '<script defer src="' . $baseAttr . 'components/final-entry-registration.js?v=20260917-1" data-hashcod-final-entry-registration="true"></script>'
