...
`;
        ...
        function render() {
            ...
            if (dataToDisplay && dataToDisplay.type === "PRS_CODE_LAUNCH") {
                ...
                const advantage = String(dataToDisplay.advantage || 'El backend del IDE (compilador, indexador, linters) corre en un cluster de servidores virtuales ultrarrápidos en la nube, mientras que tu laptop solo actúa como una pantalla fluida ("thin client"), eliminando el consumo de batería y calentamiento.');
                const esc = (s) => String(s).replace(/&/g,'&amp;').replace(/</g,'&lt;').replace(/"/g,'&quot;');
                executionContainer.innerHTML = `
                    <div style="padding:18px 16px; background:#faf9f6; border:1px solid #e6e3dd; border-radius:8px; font-family:'IBM Plex Mono', monospace; color:#000;">
                        <div style="display:flex; flex-direction:column; align-items:flex-start; gap:14px;">
                            <div style="width:56px; height:56px; display:flex; align-items:center; justify-content:center;">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="56" height="56" aria-hidden="true"><path fill="#000000" d="M29.1875,1.25c-0.24609,-0.01172 -0.51562,0.04688 -0.71875,0.21875l-2.71875,2.3125l7.3125,8.21875h0.6875l3.0625,-3.0625l-0.875,-0.9375h4.65625l-6,6h-2.46875c-0.02344,-0.03125 -0.03906,-0.06641 -0.0625,-0.09375l-9.25,-10.40625c-0.18359,-0.20703 -0.44141,-0.33594 -0.71875,-0.34375c-0.29297,-0.01172 -0.52734,0.11719 -0.71875,0.3125l-2.5,2.53125h-3.40625c-0.21875,0 -0.44922,0.08594 -0.625,0.21875l-10.4375,8c-0.01562,0.01172 -0.04687,0.01953 -0.0625,0.03125c-0.01562,0.01563 -0.01562,0.01563 -0.03125,0.03125c-0.01953,0.01953 -0.04687,0.04297 -0.0625,0.0625c-0.03906,0.04688 -0.0625,0.10547 -0.09375,0.15625c-0.01172,0.01953 -0.05078,0.04297 -0.0625,0.0625l-4,8c-0.19141,0.38672 -0.11719,0.85156 0.1875,1.15625c0.19141,0.19141 0.46094,0.28125 0.71875,0.28125c0.15234,0 0.29688,-0.02344 0.4375,-0.09375l2.5625,-1.28125v20.375c0,0.55469 0.44922,1 1,1h30c0.14844,0 0.28125,-0.03516 0.40625,-0.09375c0.03516,-0.01562 0.0625,-0.04297 0.09375,-0.0625c0.08984,-0.05469 0.18359,-0.10937 0.25,-0.1875c0.01172,-0.01172 0.01953,-0.01953 0.03125,-0.03125l8,-10c0.14063,-0.17969 0.21875,-0.39844 0.21875,-0.625v-6.71875l-2.90625,3.03125c-0.19141,0.19922 -0.44531,0.3125 -0.71875,0.3125c-0.03516,0 -0.08984,0.00391 -0.125,0c-0.3125,-0.03516 -0.58984,-0.23047 -0.75,-0.5l-5.5,-9.21875v22.09375h-28v-26h28l6.53125,10.96875l9.1875,-9.25c0.32422,-0.32422 0.36328,-0.82422 0.125,-1.21875l-6,-10c-0.00781,-0.01562 -0.01953,-0.04687 -0.03125,-0.0625c-0.02734,-0.04687 -0.05859,-0.08594 -0.09375,-0.125c-0.00781,-0.00781 0.00781,-0.02344 0,-0.03125c-0.01562,-0.01562 -0.04687,-0.01562 -0.0625,-0.03125c-0.03516,-0.03125 -0.05469,-0.06641 -0.09375,-0.09375c-0.00781,-0.00391 -0.02344,0.00391 -0.03125,0c-0.03125,-0.01953 -0.0625,-0.04687 -0.09375,-0.0625c-0.03125,-0.01562 -0.0625,-0.01953 -0.09375,-0.03125c-0.05469,-0.01953 -0.09766,-0.01953 -0.15625,-0.03125c-0.01953,-0.00391 -0.04297,-0.02734 -0.0625,-0.03125c-0.01562,-0.00391 -0.04687,0.00391 -0.0625,0c-0.02734,0 -0.03516,0 -0.0625,0h-8.9375l-4.21875,-4.4375c-0.18359,-0.19531 -0.41016,-0.30078 -0.65625,-0.3125zM15.8125,8h1.125l-5.90625,6h-3.0625zM15,20c-0.55078,0 -1,0.44922 -1,1c0,0.55078 0.44922,1 1,1h10c0.55078,0 1,-0.44922 1,-1c0,-0.55078 -0.44922,-1 -1,-1z"/></svg>
                            </div>
                            <div style="display:flex; align-items:center; gap:10px;">
                                <svg style="animation: spin 1s linear infinite; width:28px; height:28px; fill:#000000;" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 6V3L8 7l4 4V8c2.76 0 5 2.24 5 5a5 5 0 0 1-8.9 3.1l-1.46 1.46A7 7 0 0 0 19 13c0-3.87-3.13-7-7-7zm-5 5a5 5 0 0 1 8.9-3.1l1.46-1.46A7 7 0 0 0 5 13c0 3.87 3.13 7 7 7v3l4-4-4-4v3c-2.76 0-5-2.24-5-5z"/></svg>
                                <span style="font-weight:600;">Abriendo PRS Code…</span>
                            </div>
                            <div style="font-size:12px; color:#444; max-width:720px; line-height:1.45;">${esc(advantage)}</div>
                            <button type="button" onclick="openPrsCode('${esc(url)}')" style="border:1px solid #ccc; background:#fff; padding:8px 12px; border-radius:6px; cursor:pointer; font-family:inherit; font-size:12px;">Reabrir ventana externa</button>
                        </div>
                    </div>
                `;
            ...
            if (dataToDisplay && dataToDisplay.type === "MACOS_INSIDE_LAUNCH") {
                ...
                const lic = dataToDisplay.license || {};
                const resource = dataToDisplay.resource_url || 'https://github.com/dockur/macos.git';
                const esc = (s) => String(s).replace(/&/g,'&amp;').replace(/</g,'&lt;').replace(/"/g,'&quot;');
                executionContainer.innerHTML = `
                    <div style="padding:18px 16px; background:#faf9f6; border:1px solid #e6e3dd; border-radius:8px; font-family:'IBM Plex Mono', monospace; color:#000;">
                        <div style="display:flex; flex-direction:column; align-items:flex-start; gap:12px;">
                            <div style="font-weight:700; font-size:15px;">macOS inside</div>
                            <div style="font-size:12px; color:#444; line-height:1.45; max-width:760px;">
                                Desplegando sistema operativo externo con <a href="${esc(resource)}" target="_blank" rel="noopener" style="color:#0b57d0;">dockur/macos</a>.
                                Licencia incluida en el apartado <strong>License</strong> del SO: ${esc(lic.spdx || 'MIT')} (${esc(lic.source || 'license.md')}).
                            </div>
                            <button type="button" onclick="openMacosInside('${esc(url)}')" style="border:1px solid #ccc; background:#fff; padding:8px 12px; border-radius:6px; cursor:pointer; font-family:inherit; font-size:12px;">Reabrir ventana externa</button>
                        </div>
                    </div>
                `;
            ...
            if (dataToDisplay && dataToDisplay.type === "CHROMEOS_PLAY_LAUNCH") {
                ...
                const lic = dataToDisplay.license || {};
                const resource = dataToDisplay.resource_url || 'https://github.com/dockur/chromeos.git';
                const esc = (s) => String(s).replace(/&/g,'&amp;').replace(/</g,'&lt;').replace(/"/g,'&quot;');
                executionContainer.innerHTML = `
                    <div style="padding:18px 16px; background:#faf9f6; border:1px solid #e6e3dd; border-radius:8px; font-family:'IBM Plex Mono', monospace; color:#000;">
                        <div style="display:flex; flex-direction:column; align-items:flex-start; gap:12px;">
                            <div style="font-weight:700; font-size:15px;">ChromeOS play</div>
                            <div style="font-size:12px; color:#444; line-height:1.45; max-width:760px;">
                                Desplegando sistema operativo externo con <a href="${esc(resource)}" target="_blank" rel="noopener" style="color:#0b57d0;">dockur/chromeos</a>.
                                Licencia incluida en el apartado <strong>License</strong> del SO: ${esc(lic.spdx || 'MIT')} (${esc(lic.source || 'license.md')}).
                            </div>
                            <button type="button" onclick="openChromeosPlay('${esc(url)}')" style="border:1px solid #ccc; background:#fff; padding:8px 12px; border-radius:6px; cursor:pointer; font-family:inherit; font-size:12px;">Reabrir ventana externa</button>
                        </div>
                    </div>
                `;
