            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" role="img" aria-hidden="true">
                <g fill="none" fill-rule="nonzero">
                    <g transform="scale(5.12,5.12)">
                        <path d="M45.621,12.989h-41.121c-0.276,0 -0.5,-0.224 -0.5,-0.5v-5.989c0,-0.276 0.224,-0.5 0.5,-0.5h41c0.271,0 0.493,0.216 0.5,0.487c0.057,2.133 0.096,4.122 0.121,5.996c0.002,0.134 -0.05,0.263 -0.144,0.358c-0.095,0.095 -0.223,0.148 -0.356,0.148zM5,11.989h40.114c-0.023,-1.575 -0.056,-3.234 -0.101,-4.989h-40.013z" fill="#111111"></path>
                        <path d="M44.845,44.094c-9.085,-0.488 -19.491,-0.4 -40.345,-0.499v-31.106c16.028,0.084 31.056,0.133 41,0c0.56,17.706 -0.553,24.177 -0.655,31.605z" fill="#000000"></path>
                        <path d="M44.845,44.594c-0.009,0 -0.018,0 -0.027,0c-7.163,-0.386 -15.182,-0.411 -28.468,-0.454c-3.545,-0.011 -7.468,-0.024 -11.853,-0.045c-0.275,-0.002 -0.497,-0.225 -0.497,-0.5v-31.106c0,-0.133 0.053,-0.261 0.147,-0.354c0.094,-0.093 0.22,-0.146 0.353,-0.146c0.001,0 0.002,0 0.002,0c15.283,0.082 30.826,0.136 40.991,0c0.002,0 0.005,0 0.007,0c0.27,0 0.491,0.214 0.5,0.484c0.385,12.167 -0.019,19.037 -0.343,24.556c-0.15,2.548 -0.279,4.75 -0.311,7.071c-0.002,0.136 -0.059,0.266 -0.159,0.358c-0.093,0.088 -0.215,0.136 -0.342,0.136zM5,43.097c4.184,0.02 7.943,0.032 11.353,0.042c12.983,0.042 20.944,0.067 28.001,0.428c0.042,-2.155 0.165,-4.226 0.304,-6.597c0.319,-5.425 0.715,-12.158 0.358,-23.976c-10.066,0.129 -25.137,0.076 -40.016,-0.002z" fill="#111111"></path>
                        <path d="M11.355,12.893c-0.273,0 -0.496,-0.219 -0.5,-0.493l-0.081,-5.36c-0.004,-0.276 0.216,-0.503 0.493,-0.507c0.25,-0.033 0.502,0.216 0.507,0.493l0.081,5.36c0.004,0.276 -0.216,0.503 -0.493,0.507c-0.002,0 -0.005,0 -0.007,0z" fill="#111111"></path>
                        <path d="M22.854,34.654c-0.066,0 -0.134,-0.013 -0.199,-0.041c-0.253,-0.11 -0.37,-0.404 -0.26,-0.658c0.039,-0.089 3.848,-8.886 4.602,-11.205c0.086,-0.263 0.368,-0.406 0.63,-0.321c0.263,0.085 0.407,0.368 0.321,0.63c-0.768,2.364 -4.478,10.931 -4.635,11.294c-0.082,0.188 -0.266,0.301 -0.459,0.301z" fill="#ffffff"></path>
                        <path d="M30.907,31.516c-0.184,0 -0.36,-0.101 -0.448,-0.276c-0.124,-0.247 -0.023,-0.547 0.224,-0.671c0.32,-0.16 2.656,-1.545 4.07,-2.387l-3.676,-2.808c-0.219,-0.168 -0.261,-0.481 -0.094,-0.701c0.168,-0.218 0.482,-0.26 0.701,-0.094l4.263,3.257c0.132,0.101 0.205,0.26 0.195,0.426c-0.009,0.166 -0.1,0.316 -0.243,0.401c-0.438,0.262 -4.293,2.562 -4.77,2.801c-0.071,0.035 -0.147,0.052 -0.222,0.052z" fill="#ffffff"></path>
                        <path d="M19.715,31.575c-0.086,0 -0.174,-0.022 -0.254,-0.07l-4.796,-2.842c-0.145,-0.086 -0.237,-0.239 -0.245,-0.407c-0.008,-0.168 0.07,-0.33 0.207,-0.428l4.915,-3.553c0.223,-0.162 0.536,-0.112 0.698,0.112c0.162,0.224 0.111,0.537 -0.112,0.698l-4.297,3.106l4.14,2.453c0.238,0.141 0.316,0.447 0.175,0.685c-0.093,0.159 -0.26,0.246 -0.431,0.246z" fill="#ffffff"></path>
                    </g>
                </g>
            </svg>
        </div>
            ...
            if (dataToDisplay && (dataToDisplay.type === "REPOS_CATALOG" || dataToDisplay.type === "REPO_CLONE_RESULT")) {
                ...
                if (repos.length === 0) {
                    ...
                    repos.forEach(r => {
                        ...
                        // Icono código a la izquierda de Guardar / GitHub / Pull
