...
putenv('RENDER=true');
$edge = ['REMOTE_ADDR'=>'127.0.0.1', 'HTTP_X_L8_RENDER_CF_IP'=>ADMIN_DEVICE_IP];
...
check(adminClientIp(array_replace($edge, ['HTTP_X_FORWARDED_FOR'=>'192.0.2.1, 38.196.115.184'])) === ADMIN_DEVICE_IP, 'forged XFF ignored');
check(adminClientIp(array_replace($edge, ['HTTP_X_L8_RENDER_CF_IP'=>'192.0.2.1, 38.196.115.73'])) === '', 'CF header must contain one address');
check(adminClientIp(['REMOTE_ADDR'=>'127.0.0.1','HTTP_X_L8_RENDER_XFF'=>ADMIN_DEVICE_IP]) === '', 'legacy proxy header cannot authorize');
check(adminClientIp(['REMOTE_ADDR'=>'127.0.0.1','HTTP_CF_CONNECTING_IP'=>ADMIN_DEVICE_IP]) === '', 'raw CF header cannot authorize');
...
$_SERVER['HTTP_X_L8_RENDER_CF_IP'] = ADMIN_DEVICE_IP;
