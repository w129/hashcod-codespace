...
assert(js.includes('const ROTATION_MS = 1000;'), 'candidate key must rotate every second');
...
assert(adminDevice.includes('dilithium-one-time-key.js?v=20260910-1'), 'admin loader must load new tool');
assert(adminDevice.includes('dilithium-one-time-key.css?v=20260910-1'), 'admin loader must load new styles');
