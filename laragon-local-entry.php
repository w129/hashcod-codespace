...
$html = str_replace(
    ...
    'components/admin-hello-button.js?v=20260918-registration22',
    $html
);
...
$headExtras = '<base href="' . $baseAttr . '">'
    ...
    . '<link rel="stylesheet" href="' . $baseAttr . 'components/platform-registration-form.css?v=20260918-21" data-hashcod-platform-registration-style="true">'
    ...
    . '<link rel="stylesheet" href="' . $baseAttr . 'components/platform-entry-hold.css?v=20260918-2" data-hashcod-platform-entry-hold-style="true">'
...
$registrationFlipTag = $registrationFlipBundle !== ''
    ...
    : '<script defer src="' . $baseAttr . 'components/registration-flip.bundle.js?v=20260918-2" data-hashcod-registration-flip="official"></script>';
...
$bodyExtras = '<script defer src="' . $baseAttr . 'components/legacy-auth-retirement.js?v=20260918-2" data-hashcod-legacy-auth-retirement="true"></script>'
    ...
    . '<script defer src="' . $baseAttr . 'components/platform-entry-hold.js?v=20260918-27" data-platform-entry-hold="true"></script>'
    . '<script defer src="' . $baseAttr . 'components/platform-registration-form.js?v=20260918-27" data-hashcod-platform-registration="true"></script>'
    ...
    . '<script defer src="' . $baseAttr . 'components/admin-codekey-picker-rescue.js?v=20260918-2" data-hashcod-codekey-picker-rescue="true"></script>'
