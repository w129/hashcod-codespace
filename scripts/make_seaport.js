...
fs.writeFileSync('components/data-seaport.js', code, 'utf8');
console.log('Written components/data-seaport.js successfully! Length:', code.length);
...
['index.html', '404.html'].forEach(f => {
    ...
    if (text.includes(target) && !text.includes('data-seaport.js')) {
        ...
        console.log('Updated ' + f + ' with data-seaport.js');
    }
});
