...
$html = str_replace(
    ...
    'components/admin-hello-button.js?v=20260918-registration19',
    $html
);
...
$headExtras = '<base href="' . $baseAttr . '">'
    ...
    . '<link rel="stylesheet" href="' . $baseAttr . 'components/platform-registration-form.css?v=20260918-18" data-hashcod-platform-registration-style="true">'
