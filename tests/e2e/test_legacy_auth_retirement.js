...
assert(hosted.includes('components/legacy-auth-retirement.js?v=20260917-1'), 'hosted retirement runtime missing');
assert(local.includes('hashcod-legacy-auth-prehide'), 'local pre-paint auth suppression missing');
assert(local.includes('components/legacy-auth-retirement.js?v=20260917-1'), 'local retirement runtime missing');
