(function () {
    ...
    (function loadPlatformEntryMotionAssets() {
        ...
        if (
            ...
            link.rel = 'stylesheet';
            link.href = componentBase + 'platform-registration-form.css?v=20260918-22';
        ...
        function loadRegistrationScript() {
            ...
            registrationScript.src = componentBase + 'platform-registration-form.js?v=20260918-28';
        ...
        function loadHoldScript() {
            ...
            holdScript.src = componentBase + 'platform-entry-hold.js?v=20260918-28';
