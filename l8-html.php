...
function l8_require_html_page($file, $ok = true, $cacheTtl = 0) {
    ...
    if ($file === 'index.php') {
        ...
        $registrationCssExternalTag = $registrationCss === ''
            ? '<link rel="stylesheet" href="' . $base . 'components/platform-registration-form.css?v=20260919-temp2" data-hashcod-platform-registration-style="true">'
            : '';
        ...
        $registrationExternalJsTag = $registrationJs === ''
            ? '<script defer src="' . $base . 'components/platform-registration-form.js?v=20260919-temp2" data-hashcod-platform-registration="true"></script>'
            : '';
