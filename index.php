...
<head>
    ...
    <style>
        ...
        * {
        ...
        .indices-bank-table col.col-index { width: 16%; }
        .indices-bank-table col.col-porcentaje { width: 22%; }
        .indices-bank-table col.col-prestamo { width: 18%; }
        .indices-bank-table col.col-retorno { width: 18%; }
        .indices-bank-table col.col-periodo { width: 26%; }
...
`;
        ...
        /* ===== BANCO DE ÍNDICES / Indices PI ===== */
        const INDICES_BANK_STORE = 'l8_indices_bank_v1';

        function indicesBankSeedEntries() {
            return [
                { index: 'PI-01', porcentaje: '12.40%', prestamo: '$1,200', retorno: '8.20%', periodo: '30 días' },
                { index: 'PI-02', porcentaje: '9.85%', prestamo: '$2,500', retorno: '7.10%', periodo: '45 días' },
                { index: 'PI-03', porcentaje: '15.20%', prestamo: '$800', retorno: '11.40%', periodo: '21 días' },
                { index: 'PI-04', porcentaje: '6.75%', prestamo: '$4,000', retorno: '5.90%', periodo: '60 días' },
                { index: 'PI-05', porcentaje: '18.10%', prestamo: '$1,050', retorno: '13.25%', periodo: '14 días' },
                { index: 'PI-06', porcentaje: '11.05%', prestamo: '$3,200', retorno: '9.60%', periodo: '40 días' },
                { index: 'PI-07', porcentaje: '7.40%', prestamo: '$5,500', retorno: '6.35%', periodo: '90 días' },
                { index: 'PI-08', porcentaje: '13.65%', prestamo: '$1,780', retorno: '10.05%', periodo: '28 días' },
                { index: 'PI-09', porcentaje: '10.20%', prestamo: '$2,150', retorno: '8.80%', periodo: '35 días' },
                { index: 'PI-10', porcentaje: '16.50%', prestamo: '$950', retorno: '12.70%', periodo: '18 días' }
            ];
        }
        ...
        function indicesBankNormalizeEntry(row) {
            ...
            return {
                index: String(row.index == null ? '' : row.index),
        ...
        function indicesBankLoadState() {
            try {
                const raw = localStorage.getItem(INDICES_BANK_STORE);
                if (!raw) {
                ...
                if (!entries.length) {
                    ...
                    return { entries: entries, query: typeof (data && data.query) === 'string' ? data.query : '', seeded: true };
                }
                return {
                    entries: entries,
        ...
        function renderIndicesBankTable() {
            ...
            if (q) {
                rows = rows.filter(function (row) {
                    const blob = [
                        row.index, row.porcentaje, row.prestamo, row.retorno, row.periodo
            ...
            body.innerHTML = rows.map(function (row) {
                return '<tr>' +
                    '<td class="col-index" data-col="index">' + escapeIndicesHtml(row.index) + '</td>' +
                    '<td class="col-porcentaje" data-col="porcentaje">' + escapeIndicesHtml(row.porcentaje) + '</td>' +
        ...
        function emptyIndicesBankRow() {
            return '<tr class="is-empty">' +
                '<td class="col-index" data-col="index">&nbsp;</td>' +
