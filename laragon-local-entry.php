...
$html = str_replace(
    ...
    'components/admin-hello-button.js?v=20260918-registration13',
    $html
);
...
$bodyExtras = '<script defer src="' . $baseAttr . 'components/legacy-auth-retirement.js?v=20260918-2" data-hashcod-legacy-auth-retirement="true"></script>'
    ...
    . '<script defer src="' . $baseAttr . 'components/platform-entry-hold.js?v=20260918-18" data-platform-entry-hold="true"></script>'
    . '<script defer src="' . $baseAttr . 'components/platform-registration-form.js?v=20260918-18" data-hashcod-platform-registration="true"></script>'
