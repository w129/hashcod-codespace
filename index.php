...
<body>
                        ...
                        <div class="vk-card-panel">
                            ...
                            <div class="vk-card-body" id="keyWindowBody">
                                <div class="keys-grid-placeholder" style="flex: 1; border: 1px dashed #d0cdcf; border-radius: 8px; background: #ffffff; display: flex; flex-direction: column; align-items: center; justify-content: center; color: #8c8983; font-size: 12px; font-family: 'IBM Plex Mono', monospace; min-height: 280px; padding: 12px; text-align: center; gap: 12px;">
                                    ...
                                    <button class="upload-btn" onclick="triggerFileUpload()">📤 Subir Archivo a la Super Base de Datos</button>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function render() {
            ...
            // RENDERIZADO ESPECIAL PARA EL COMANDO set_I code (SUPER BASE DE DATOS GLOBAL)
            if (dataToDisplay && dataToDisplay.type === "GLOBAL_FILES_CATALOG") {
                ...
                let rowsHtml = '';
                if (files.length === 0) {
                    rowsHtml = `<tr><td colspan="5" style="text-align:center; padding:20px; color:#888;">No hay archivos almacenados todavía en la Super Base de Datos. Haz clic en 'Subir Nuevo Archivo' para subir uno.</td></tr>`;
                } else {
                    files.forEach(f => {
                        rowsHtml += `
                            <tr>
                    ...
                    <div class="catalog-container">
                        <div class="catalog-banner">
                            <div class="catalog-info">
                                <span>📁 Archivos en Base de Datos: <span class="catalog-badge">${files.length}</span></span>
