...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* ===== FLY: barrita negra pegada a la derecha (misma ancla que la barra) ===== */
        #flyRail.fly-rail {
        ...
        /* Barrita Fly: pegada al borde derecho, mismo centro que la barra abierta */
        #flyRail .fly-handle {
            pointer-events: auto;
            appearance: none;
        ...
        #flyRail .fly-handle:hover::before {
        ...
        /* Al abrir: barrita se guarda; barra sale en el mismo sitio (derecha + centro) */
...
`;
    ...
    <aside
        ...
        class="fly-rail"
        aria-label="Fly"
        style="position:fixed;right:0;top:50%;transform:translateY(-50%);z-index:9990;display:block;width:56px;height:280px;"
    >
        <button
            type="button"
            class="fly-handle"
            ...
            style="width:22px;height:88px;background:transparent;border:none;border-radius:999px;padding:0;cursor:pointer;display:block;position:relative;"
        ></button>
