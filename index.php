...
`;
        ...
        function tokensUnlockIconSvg(kind) {
            const k = String(kind || '');
            if (k === 'ext') {
                return '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M14 3h7v7h-2V6.4l-9.3 9.3-1.4-1.4L17.6 5H14V3zM5 5h6v2H7v10h10v-4h2v6H5V5z"/></svg>';
            }
            if (k === 'clone') {
                return '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6 2h9l5 5v15H6V2zm8 1.5V8h4.5L14 3.5zM8 12h8v2H8v-2zm0 4h8v2H8v-2z"/></svg>';
            }
            if (k === 'kit') {
                return '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3 7l9-4 9 4v10l-9 4-9-4V7zm9 1.2L6.2 11 12 13.8 17.8 11 12 8.2zM5 12.7v3.6l6 2.7v-3.6l-6-2.7zm14 0l-6 2.7v3.6l6-2.7v-3.6z"/></svg>';
            }
