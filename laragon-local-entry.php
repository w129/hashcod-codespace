...
$headExtras = '<base href="' . $baseAttr . '">'
    ...
    . '<link rel="stylesheet" href="' . $baseAttr . 'components/platform-registration-form.css?v=20260918-3" data-hashcod-platform-registration-style="true">'
...
$bodyExtras = '<script defer src="' . $baseAttr . 'components/legacy-auth-retirement.js?v=20260917-1" data-hashcod-legacy-auth-retirement="true"></script>'
    ...
    . '<script defer src="' . $baseAttr . 'components/platform-registration-form.js?v=20260918-2" data-hashcod-platform-registration="true"></script>'
